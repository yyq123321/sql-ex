...
export async function sendStudentVerifiedCode(params: string): Promise<{ data: number }> {
...
export async function sendTeacherVerifiedCode(params: string): Promise<{ data: number }> {
...
export async function studentModify(params: ModifyParams): Promise<{ data: number }> {
...
export async function teacherModify(params: ModifyParams): Promise<{ data: number }> {
...
export async function queryUserMsgNum(params: string): Promise<{ data: number }> {

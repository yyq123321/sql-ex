    ...
    <PageContainer
      ...
      header={{
        ...
        extra: [
          ...
          data?.status == 1 && buy == 0 && initialState?.currentUser?.access == 'canStudent' ? (
    ...
    >
      ...
      <Card loading={loading}>
        ...
        <Descriptions title="教师信息" style={{ marginBottom: 32 }}>
          ...
          <Descriptions.Item label="教师简介">
            {data?.teacherVO.introduction || '暂无'}
          </Descriptions.Item>
      ...
      >
        <TextArea
          ...
          ref={inputRef}
        />
        <Button type="primary" onClick={publishComment}>
          发布评论
        </Button>
            ...
            <List.Item
              ...
              actions={[
                <Button
                  type="text"
                  icon={<HeartOutlined />}
                  onClick={() => handleLikeComment(item.commentId)}
                >
                  {' '}
                  {item.praiseCount}
                </Button>,
                <Button type="text" icon={<MessageOutlined />} onClick={showChildComments}>
                  {' '}
                  {item.replyCount}
                </Button>,
              ]}

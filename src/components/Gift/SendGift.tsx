...
const SendGiftModal: React.FC<Props> = (props) => {
  ...
  const randomTexts = [
    '注册即送100坤币💰奖励，API接口开放平台为您提供稳定、安全、高效的接口调用服务！',
    '免费领取100坤币💰奖励，通过链接注册，API接口开放平台为您提供稳定、安全、高效的接口调用服务！',
    '通过链接注册，即可获得100坤币💰奖励，API接口开放平台为您提供稳定、安全、高效的接口调用服务！',
  ];
  ...
  return (
    <Modal footer={null} centered open={open} width={800} onCancel={onCancel}>
      <ProCard direction={'column'}>
        ...
        <ProCard layout={'center'}>
          {contextHolder}
          <p style={{ marginTop: -15, color: 'red' }}>异常刷取积分将永久封禁账号</p>
        </ProCard>
      </ProCard>
    </Modal>
  );
